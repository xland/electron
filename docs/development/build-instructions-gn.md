...
`cc_wrapper = "sccache"` by running `gn args out/Debug`(where Debug could also be Testing, or Release) to bring up an editor and adding a line to the end of the file.
